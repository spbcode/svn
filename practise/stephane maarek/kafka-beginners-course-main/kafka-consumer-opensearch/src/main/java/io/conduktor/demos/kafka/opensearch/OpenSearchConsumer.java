...
//        String connString = "https://c9p5mwld41:45zeygn9hy@kafka-course-2322630105.eu-west-1.bonsaisearch.net:443";
        ...
        if (userInfo == null) {
            ...
            log.info("created restHighLevelClient "+restHighLevelClient.toString());
...
//                        log.info("id::"+id+"-----  record.value()::"+record.value());
...
//                    log.info("openSearchClient:::::::::"+openSearchClient.toString());
